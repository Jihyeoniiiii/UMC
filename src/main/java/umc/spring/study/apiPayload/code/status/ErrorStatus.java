...
public enum ErrorStatus implements BaseErrorCode {
    ...
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "CATEGORY001", "카테고리가 없습니다."),
    STORE_NOT_FOUND(HttpStatus.NOT_FOUND, "STORE4001", "가게가 없습니다."),
    MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "MISSIOON001", "미션이 없습니다."),
    PAGE_NOT_ACCESS(HttpStatus.BAD_REQUEST,"PAGE400","페이지 접근이 불가능합니다.");
